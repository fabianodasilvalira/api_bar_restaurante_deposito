from sqlalchemy import Column, String, Boolean, DateTime, func, ForeignKey, Integer, Numeric, Text
...
class Mesa(Base):
    ...
    qr_code_hash = Column(String, unique=True, nullable=True, index=True) # Nullable se o QR code for gerado depois
    ...
    comanda_ativa = relationship("Comanda", uselist=False, back_populates="mesa", primaryjoin="and_(Mesa.id==Comanda.id_mesa, Comanda.status_pagamento!='Totalmente Pago', Comanda.status_pagamento!='Fiado Fechado')") # Tentativa de pegar comanda ativa
